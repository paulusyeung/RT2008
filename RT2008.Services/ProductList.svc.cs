...
namespace RT2008.Services
{
    ...
    public class ProductList : IProductList
    {
        ...
        /// </summary>
        /// <returns></returns>
        public RT2008.Services.Model.ProductList[] GetProductList()
        {
        ...
        /// <returns></returns>
        public RT2008.Services.Model.ProductList[] GetProductListByWhereClause(string whereClause)
        {
        ...
        /// <returns></returns>
        public RT2008.Services.Model.ProductList[] GetProductListByStockCode(string stkCode)
        {
        ...
        /// <returns></returns>
        public RT2008.Services.Model.ProductList GetProductWithProductId(string productId)
        {
        ...
        /// <returns></returns>
        public RT2008.Services.Model.ProductList GetProduct(string stkCode, string appendix1, string appendix2, string appendix3)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public RT2008.Services.Model.ProductList GetFirstProduct()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public RT2008.Services.Model.ProductList GetLastProduct()
        {
            sql = "SELECT TOP 1 * FROM (" + sql + ") lst ";
