...
namespace RT2008.Services
{
    ...
    public class TransactionList : ITransactionList
    {
        ...
        public RT2008.Services.Model.TransactionList[] GetTransactionList()
        {
            return GetTransactionList(sql);
        }

        public RT2008.Services.Model.TransactionList GetFirstTransaction(string txType, bool posted)
        {
        ...
        public RT2008.Services.Model.TransactionList GetLastTransaction(string txType, bool posted)
        {
            sql += " WHERE TxType = '" + txType + "' AND Posted = " + (posted ? "1" : "0");
        ...
        public RT2008.Services.Model.TransactionList[] GetTransactionListByWhereClause(string whereClause)
        {
