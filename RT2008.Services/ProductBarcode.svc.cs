...
namespace RT2008.Services
{
    ...
    public class ProductBarcode : IProductBarcode
    {
        ...
        /// </summary>
        /// <returns></returns>
        public RT2008.Services.Model.ProductBarcode[] GetAllBarcode()
        {
        ...
        /// <returns></returns>
        public RT2008.Services.Model.ProductBarcode[] GetBarcodeListByWhereClause(string whereClause)
        {
        ...
        /// <returns></returns>
        public RT2008.Services.Model.ProductBarcode[] GetBarcodeListByStockCode(string stkCode)
        {
        ...
        /// <returns></returns>
        public RT2008.Services.Model.ProductBarcode[] GetBarcodeListByBarcode(string barcode)
        {
        ...
        /// <returns></returns>
        public RT2008.Services.Model.ProductBarcode GetBarcodeWithProductId(string productId)
        {
        ...
        /// <returns></returns>
        public RT2008.Services.Model.ProductBarcode GetBarcode(string stkCode, string appendix1, string appendix2, string appendix3)
        {
