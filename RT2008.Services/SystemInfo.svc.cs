...
namespace RT2008.Services
{
    ...
    public class SystemInfo : ISystemInfo
    {
        ...
        public RT2008.Services.Model.SystemInfo GetSystemInfo()
        {
        ...
        public RT2008.Services.Model.SystemInfo GetSystemInfoById(string infoId)
        {
            string sql = @"SELECT TOP 1 [InfoId],[ShopNumber],[CompanyName],[LastMonthEnd],[BasicCurrency],[BarcodeLabelFormat]
                            FROM [dbo].[SystemInfo]
                            WHERE [InfoId] = '" + infoId + "'";
        ...
        public RT2008.Services.Model.SystemInfo GetSystemInfoByCode(string shopNumber)
        {
            string sql = @"SELECT TOP 1 [InfoId],[ShopNumber],[CompanyName],[LastMonthEnd],[BasicCurrency],[BarcodeLabelFormat]
                            FROM [dbo].[SystemInfo]
        ...
        public RT2008.Services.Model.SystemInfo GetSystemInfoByWhereClause(string whereClause)
        {
            string sql = @"SELECT TOP 1 [InfoId],[ShopNumber],[CompanyName],[LastMonthEnd],[BasicCurrency],[BarcodeLabelFormat]
                            FROM [dbo].[SystemInfo]";
