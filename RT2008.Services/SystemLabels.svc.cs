...
namespace RT2008.Services
{
    ...
    public class SystemLabels : ISystemLabels
    {
        ...
        public RT2008.Services.Model.SystemLabels GetSystemLabels()
        {
        ...
        public RT2008.Services.Model.SystemLabels GetSystemLabelsByLanguage(string languageCode)
        {
            string sql = @"SELECT [LabelId],[LanguageCode],[STKCODE],[CLASS1],[CLASS2],[CLASS3],[CLASS4],[CLASS5],[CLASS6]
                                  ,[APPENDIX1],[APPENDIX2],[APPENDIX3],[REMARK1],[REMARK2],[REMARK3],[REMARK4],[REMARK5],[REMARK6]
                              FROM [dbo].[SystemLabel]
        ...
        public RT2008.Services.Model.SystemLabels GetSystemLabelsByWhereClause(string whereClause)
        {
            string sql = @"SELECT [LabelId],[LanguageCode],[STKCODE],[CLASS1],[CLASS2],[CLASS3],[CLASS4],[CLASS5],[CLASS6]
                                  ,[APPENDIX1],[APPENDIX2],[APPENDIX3],[REMARK1],[REMARK2],[REMARK3],[REMARK4],[REMARK5],[REMARK6]
                              FROM [dbo].[SystemLabel]";
