...
namespace RT2008.PriceMgmt
{
    public partial class PriceMgmtWizard_Details : UserControl
    {
        ...
        {
            txtSTKCODE.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;
            txtDescription.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;
            txtAverageCost.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;
            txtOldPrice.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;
            txtDifference.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;
            txtOldMarkUp.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;
            txtNewMarkUp.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;
            txtOldDiscount.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;

            colSTKCODE.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("STKCODE");
            ...
            colClass1.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS1");
            colClass2.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS2");
            colClass3.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS3");
            colClass4.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS4");
            colClass5.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS5");
            colClass6.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS6");
