...
namespace RT2008.PriceMgmt
{
    public partial class Authorization : Form
    {
        ...
        private void SetAttributes()
        {
            ...
            this.txtPostedOn.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;
            this.txtCurrentSystemMonth.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;
            this.txtCurrentSystemYear.BackColor = RT2008.SystemInfo.ControlBackColor.DisabledBox;

            this.txtPostedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(DateTime.Now, true);
            this.txtCurrentSystemMonth.Text = RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemMonth;
            this.txtCurrentSystemYear.Text = RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemYear;
        ...
        private void BindingAuthList()
        {
            ...
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(cmd))
            {
                while (reader.Read())
                {
                    ...
                    objItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(8), false)); // Modified On
