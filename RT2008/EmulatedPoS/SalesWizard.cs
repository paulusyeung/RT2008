...
namespace RT2008.EmulatedPoS
{
    public partial class SalesWizard : Form
    {
        ...
        public SalesWizard(RT2008.DAL.Common.Enums.TxType salesType)
        {
            InitializeComponent();
        ...
        public SalesWizard(Guid posId, RT2008.DAL.Common.Enums.TxType salesType)
        {
            InitializeComponent();
        ...
        {
            if (this.SalesType == RT2008.DAL.Common.Enums.TxType.CAS) //input
            {
            ...
            else if (this.SalesType == RT2008.DAL.Common.Enums.TxType.CRT) // return
            {
        ...
        private void cmdPreview_Click()
        {
            ...
            string[,] param = { 
                                  ...
                                  {"FromDate",dtpTxDate.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
                                  {"ToDate",dtpTxDate.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
            ...
            oViewer.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_vwRptEPOSWorksheet";
            oViewer.ReportName = "RT2008.EmulatedPoS.Reports.WorksheetRdl.rdlc";
        ...
        {
            RT2008.DAL.Staff.LoadCombo(ref cboStaff1, new string[] { "StaffNumber", "FullName" }, "{0} - {1}", false, false, string.Empty, string.Empty, null);
        ...
        {
            RT2008.DAL.Staff.LoadCombo(ref cboStaff2, new string[] { "StaffNumber", "FullName" }, "{0} - {1}", false, false, string.Empty, string.Empty, null);
        }
        ...
        {
            RT2008.DAL.PromotionPaymentFactor.LoadCombo(ref cboEvtCode, "EventCode", false);
        }
        ...
        {
            RT2008.DAL.Currency.LoadCombo(ref cboCurrencyCode, "CurrencyCode", false);
        ...
        {
            RT2008.DAL.ProductPriceType.LoadCombo(ref cboPriceType, "PriceType", false);
        }
        ...
        {
            RT2008.DAL.Member.LoadCombo(ref cboMemberNumber, "MemberNumber", false);
        }
        ...
        {
            RT2008.DAL.Member.LoadCombo(ref cboFullName, "FullName", false);
        }
        ...
        {
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode01, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("01"), null);
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode02, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("02"), null);
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode03, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("03"), null);
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode04, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("04"), null);
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode05, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("05"), null);
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode06, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("06"), null);
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode07, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("07"), null);
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode08, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("08"), null);
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode09, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("09"), null);
            RT2008.DAL.PosAnalysisCode.LoadCombo(ref cboAnalysisCode10, new string[] { "AnalysisCode", "CodeName" }, "{0} {1}", false, false, string.Empty, string.Empty, GetAnalysisSqlCondition("10"), null);
        }
            ...
            if (errorProvider.GetError(cboWorkplace).Length == 0 && errorProvider.GetError(cboStaff1).Length == 0 && errorProvider.GetError(cboAnalysisCode01).Length == 0)
            {
                if (lvDetailsList.Items.Count > 0)
                {
                    ...
                    if (oHeader == null)
                    {
                        ...
                        txtTxNumber.Text = RT2008.SystemInfo.Settings.QueuingTxNumber(this.SalesType);
        ...
        private void LoadPOSBatchInfo()
        {
            ...
            if (oHeader != null)
            {
                ...
                txtCreateDate.Text = RT2008.SystemInfo.Settings.DateTimeToString(oHeader.CreatedOn, false);
            ...
            if (((Form)sender).DialogResult == DialogResult.Yes)
            {
                ...
                if (!this.Text.Contains("ReadOnly"))
                {
                    ...
                    if (this.HeaderId != System.Guid.Empty)
                    {
                        ...
                        this.Close();
                        RT2008.EmulatedPoS.SalesWizard wizard = new RT2008.EmulatedPoS.SalesWizard(this.HeaderId, this.SalesType);
                        wizard.ShowDialog();
                    }
                }
                else
            ...
            if (((Form)sender).DialogResult == DialogResult.Yes)
            {
                ...
                if (!this.Text.Contains("ReadOnly"))
                {
                    ...
                    if (this.HeaderId != System.Guid.Empty)
                    {
                        RT2008.SystemInfo.Settings.RefreshMainList<Default>();
                        this.Close();
                        RT2008.EmulatedPoS.SalesWizard wizard = new RT2008.EmulatedPoS.SalesWizard(this.SalesType);
                        wizard.ShowDialog();
                    }
                }
                else
        ...
        private void TabChangedMessageHandler(object sender, EventArgs e)
        {
            if (((Form)sender).DialogResult == DialogResult.Yes)
            {
                ...
                if (this.HeaderId != System.Guid.Empty)
                {
                    ...
                    this.Close();
                    RT2008.Inventory.Adjustment.Wizard wizard = new RT2008.Inventory.Adjustment.Wizard(this.HeaderId);
                    wizard.ShowDialog();
                }
            }
            else
        ...
        private void ItemInfo(ref string stkCode, ref string appendix1, ref string appendix2, ref string appendix3)
        {
            if (basicFindProduct.SelectedItem != null)
            {
                ...
                RT2008.DAL.Product oProd = RT2008.DAL.Product.Load(prodId);
                if (oProd != null)
                {
        ...
        private void LoadPosBatchTenderInfo()
        {
            ...
            else
            {
                ...
                RT2008.DAL.EPOSBatchTenderCollection posTenderCollection = RT2008.DAL.EPOSBatchTender.LoadCollection(sqlWhere);
                foreach (RT2008.DAL.EPOSBatchTender posTender in posTenderCollection)
                {
                    string typeCode;
                    RT2008.DAL.PosTenderType posType = RT2008.DAL.PosTenderType.Load(posTender.TypeId);
        ...
        private void LoadVipInfo()
        {
            if (this.HeaderId != null)
            {
                ...
                if (RT2008.DAL.Common.Config.CurrentLanguageId == 1)// English
                {
        ...
        private void InitPaymentItems(decimal amount)
        {
            ...
            RT2008.DAL.PosTenderType posTenderType = RT2008.DAL.PosTenderType.LoadWhere(sqlWhere);
        ...
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="RT2008.Controls.ProductSearcher.Basic.ProductSelectionEventArgs"/> instance containing the event data.</param>
        private void basicFindProduct_SelectionChanged(object sender, RT2008.Controls.ProductSearcher.Basic.ProductSelectionEventArgs e)
        {
        ...
        private void SearchProductBarcode(Guid productId)
        {
            ...
            RT2008.DAL.ProductBarcode productBarcode = RT2008.DAL.ProductBarcode.LoadWhere(sqlWhere);
        ...
        private void LoadMemberByMemberNumber()
        {
            if (!this.isClickFullName)
            {
                ...
                if (memNum != "RT2008.DAL.Common+ComboItem")
                {
        ...
        private void LoadMemberByFullName()
        {
            if (this.isClickFullName)
            {
                ...
                if (fullName != "RT2008.DAL.Common+ComboItem")
                {
