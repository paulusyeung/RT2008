...
namespace RT2008.EmulatedPoS
{
    public partial class FastSalesWizard : Form
    {
        ...
        public FastSalesWizard(DateTime txDate, Guid workplaceId, RT2008.DAL.Common.Enums.TxType salesType)
        {
            InitializeComponent();
        ...
        /// <param name="salesType">Type of the sales.</param>
        public FastSalesWizard(Guid headerId, RT2008.DAL.Common.Enums.TxType salesType)
        {
            InitializeComponent();
        ...
        private void InitHeaderInfo(DateTime txDate, Guid workplaceId)
        {
            ...
            txtDate.Text = txDate.ToString(RT2008.SystemInfo.Settings.GetDateFormat());
            ...
            txtLastUpdateOn.Text = DateTime.Now.ToString(RT2008.SystemInfo.Settings.GetDateTimeFormat());
            txtLastUpdateBy.Text =  GetStaffName(Common.Config.CurrentUserId);
            txtCreateDate.Text = DateTime.Now.ToString(RT2008.SystemInfo.Settings.GetDateTimeFormat());
        }
        ...
        private void LoadPOSBatchInfo()
        {
            ...
            if (oHeader != null)
            {
                ...
                txtDate.Text = RT2008.SystemInfo.Settings.DateTimeToString(oHeader.TxDate,false);
            ...
            if (((Form)sender).DialogResult == DialogResult.Yes)
            {
                ...
                if (!this.Text.Contains("ReadOnly"))
                {
                    ...
                    if (this.HeaderId != System.Guid.Empty)
                    {
                        ...
                        this.Close();
                        RT2008.EmulatedPoS.FastSalesWizard wizard = new RT2008.EmulatedPoS.FastSalesWizard(this.HeaderId, this.SalesType);
                        wizard.ShowDialog();
                    }
                }
                else
            ...
            if (((Form)sender).DialogResult == DialogResult.Yes)
            {
                ...
                if (!this.Text.Contains("ReadOnly"))
                {
                    ...
                    if (this.HeaderId != System.Guid.Empty)
                    {
                        RT2008.SystemInfo.Settings.RefreshMainList<Default>();
                        this.Close();
                        RT2008.EmulatedPoS.FastModeLogin login = new RT2008.EmulatedPoS.FastModeLogin();
        ...
        {
            RT2008.DAL.ProductBarcode productBarcode = RT2008.DAL.ProductBarcode.LoadWhere("Barcode = '" + barcode + "'");

            if (productBarcode != null)
            {
                this.ProductId = productBarcode.ProductId;
                RT2008.DAL.Product product = RT2008.DAL.Product.Load(this.ProductId);
