...
namespace RT2008.EmulatedPoS
{
    public class SalesToolbar
    {
        ...
        private void AddItemToToolBar(ToolBar atsSales)
        {
            ...
            ddlNew.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Sales - Worksheet"), string.Empty, "Sales_Worksheet"));
            ddlNew.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Sales - Worksheet (Fast)"), string.Empty, "Sales_Worksheet_Fast"));

            MenuItem priceAuth = new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Sales - Authorization"), string.Empty, "Sales_Authorization");
            priceAuth.Enabled = RT2008.Controls.UserUtility.IsAccessAllowed(Common.Enums.Permission.Posting);
            ddlNew.MenuItems.Add(priceAuth);

            ddlNew.MenuItems.Add(new MenuItem("-"));

            ddlNew.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Sales Return - Worksheet"), string.Empty, "SalesReturn_Worksheet"));

            MenuItem discAuth = new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Sales Return - Authorization"), string.Empty, "SalesReturn_Authorization");
            discAuth.Enabled = RT2008.Controls.UserUtility.IsAccessAllowed(Common.Enums.Permission.Posting);
            ...
            ddlReport.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Sales - Worksheet"), string.Empty, "Rpt_SalesWorksheet"));
            ddlReport.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Sales - History"), string.Empty, "Rpt_SalesHistory"));
            ddlReport.MenuItems.Add(new MenuItem("-"));
            ddlReport.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Sales Return - Worksheet"), string.Empty, "Rpt_SalesReturnWorksheet"));
            ddlReport.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Sales Return - History"), string.Empty, "Rpt_SalesReturnHistory"));

            ToolBarButton cmdReport = new ToolBarButton("Report", RT2008.Controls.Utility.Dictionary.GetWord("Reports"));
            ...
            if (!(e.MenuItem.Tag == null))
            {
                switch (e.MenuItem.Tag.ToString().ToLower())
                {
                    ...
                    case "rpt_salesworksheet":
                        Reports.Worksheet wizPriceWorksheet = new RT2008.EmulatedPoS.Reports.Worksheet(Common.Enums.TxType.CAS);
                        wizPriceWorksheet.SalesType = Common.Enums.TxType.CAS;
                        wizPriceWorksheet.ShowDialog();
                        break;
                    case "rpt_saleshistory":
                        Reports.History wizPriceHistory = new RT2008.EmulatedPoS.Reports.History(Common.Enums.TxType.CAS);
                        wizPriceHistory.SalesType = Common.Enums.TxType.CAS;
                        wizPriceHistory.ShowDialog();
                        break;
                    case "rpt_salesreturnworksheet":
                        Reports.Worksheet wizDiscWorksheet = new RT2008.EmulatedPoS.Reports.Worksheet(Common.Enums.TxType.CRT);
                        wizDiscWorksheet.SalesType = Common.Enums.TxType.CRT;
                        wizDiscWorksheet.ShowDialog();
                        break;
                    case "rpt_salesreturnhistory":
                        Reports.History wizDiscHistory = new RT2008.EmulatedPoS.Reports.History(Common.Enums.TxType.CRT);
