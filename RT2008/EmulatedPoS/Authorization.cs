...
namespace RT2008.EmulatedPoS
{
    public partial class Authorization : Form
    {
        ...
        /// </summary>
        public Authorization(RT2008.DAL.Common.Enums.TxType salesType)
        {
            InitializeComponent();
            InitComboBox();
        ...
        private void InitComboBox()
        {
            ...
            lblSysMonth.Text = RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemMonth;
            lblSysYear.Text = RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemYear;
        ...
        private void BindingHoldingList(SqlDataReader reader)
        {
            ...
            while (reader.Read())
            {
                ...
                objItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(5), false)); // ModifiedOn
            }
        ...
        private void lvPostTransaction_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            {
                lvPostTransaction.Items[e.Index].Checked = !(lvPostTransaction.Items[e.Index].BackColor == RT2008.SystemInfo.ControlBackColor.DisabledBox);
            }
        }
