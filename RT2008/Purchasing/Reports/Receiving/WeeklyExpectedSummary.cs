...
namespace RT2008.Purchasing.Reports.Receiving
{
    public partial class WeeklyExpectedSummary : Form
    {
        ...
        {
            RT2008.DAL.Supplier.LoadCombo(ref cboSupplierFrom, "SupplierCode", false, false, string.Empty, " Retired = 0");
        }
        ...
        {
            RT2008.DAL.Supplier.LoadCombo(ref cboSupplierTo, "SupplierCode", false, false, string.Empty, " Retired = 0");
        ...
        private void FillWorkplaceList()
        {
            ...
            WorkplaceCollection wpList = RT2008.DAL.Workplace.LoadCollection(new string[] { "WorkplaceCode" }, true);
...
ORDER BY " + orderlist + "";
        ...
        private void DoPreview()
        {
            ...
            {
                //StartOn = "SU";
                DatasourceName = "RT2008_Controls_Reporting_DataSource_vwRptPurchaseWeeklyExpectedReceivingSummaryStartOnSunday";
                reportName = "RT2008.Purchasing.Reports.Receiving.Reports.WeeklyExpectedReceivingSummary_SundayRdl.rdlc";
            }
            else if (rbMonday.Checked)
            {
                //StartOn = "MO";
                DatasourceName = "RT2008_Controls_Reporting_DataSource_vwRptPurchaseWeeklyExpectedReceivingSummaryStartOnMonday";
                reportName = "RT2008.Purchasing.Reports.Receiving.Reports.WeeklyExpectedReceivingSummary_MondayRdl.rdlc";
            }
            string[,] param ={
            {"DateBegin",this.dtDateFrom.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
            {"DateEnd",this.dtDateTo.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
