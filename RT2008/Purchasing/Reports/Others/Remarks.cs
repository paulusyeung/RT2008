////RT2008.Purchasing.Reports.Others
////RT2008.Purchasing.Reports.Others
namespace RT2008.Purchasing.Reports.Others
{
    using System;
    ...
    public partial class Remarks : Form, IGatewayComponent
    {
        ...
        private void FillFromList()
        {
            ...
            RT2008.DAL.RemarksCollection remarksCol = RT2008.DAL.Remarks.LoadCollection(orderBy, true);
        ...
        private void RdlToExcel()
        {
            string[,] param = 
            {
                ...
                { "Company", RT2008.SystemInfo.Settings.GetSystemLabelByKey("Company") } ////test data
             };

            RT2008.Controls.Reporting.RdlExport rdlExport = new RT2008.Controls.Reporting.RdlExport();

            rdlExport.Datasource = this.BindData();
            rdlExport.ReportName = "RT2008.Purchasing.Reports.Others.Reports.PORemarkRdl.rdlc";
            rdlExport.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_Remarks";
...
";
        ...
        private void CmdPreview_Click(object sender, EventArgs e)
        {
            if (this.IsSelValid("Remark Code"))
            {
                ...
                rptViewer.ReportName = "RT2008.Purchasing.Reports.Others.Reports.PORemarkRdl.rdlc";
                rptViewer.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_Remarks";
