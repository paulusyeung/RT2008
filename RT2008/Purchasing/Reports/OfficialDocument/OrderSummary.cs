            ...
            if (cboSortedBy.SelectedIndex == 0)
            {
                ...
                if (cboType.SelectedIndex == 0)
                {
                    ...
                    if (chkPrintPhoto.Checked && chkHideAPPENDIX3.Checked)
                    {
                        ...
                        rdlExport.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPurchaseOrderActivePhotoMatrixByStockCodeRdl.rdlc";
                    }
                    ...
                    {
                        ////Hide APPENDIX2
                        rdlExport.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPurchaseOrderActiveMatrixByStockCodeRdl.rdlc";
                    }
                    else
                    {
                    }
                ...
                else
                {
                    ...
                    {
                        ////Print out Item Photo AND Hide APPENDIX2
                        rdlExport.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPurchaseOrderBatchPhotoMatrixByStockCodeRdl.rdlc";
                    }
                    else if (chkPrintPhoto.Checked && !chkHideAPPENDIX3.Checked)
                    {
                        ////Print out Item Photo
                    ...
                    {
                        ////Hide APPENDIX2
                        rdlExport.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPurchaseOrderBatchMatrixByStockCodeRdl.rdlc";
                    }
                    else
                    {
                    }
...
WorkplaceId IN (" + locations + ") ";
            ...
            using (DataSet dataset = SqlHelper.Default.ExecuteDataSet(cmd))
            {
                ...
                {
                    //row["POTxType"] = Enum.GetName(typeof(RT2008.DAL.Common.Enums.POType), Convert.ToInt32(row["OrderType"].ToString())).ToString();
            ...
            if (this.IsSelValid("Supplier Code"))
            {
                ...
                if (cboSortedBy.SelectedIndex == 0)
                {
                    ...
                    if (cboType.SelectedIndex == 0)
                    {
                        ...
                        if (chkPrintPhoto.Checked && (chkHideAPPENDIX3.Checked || !chkHideAPPENDIX3.Checked))
                        {
                            ...
                            rptViewer.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPurchaseOrderActivePhotoMatrixByStockCodeRdl.rdlc";
                        }
                        else if (!chkPrintPhoto.Checked && chkHideAPPENDIX3.Checked)
                        {
                            ////Hide APPENDIX3
                            rptViewer.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPurchaseOrderActiveMatrixByStockCodeRdl.rdlc";
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        {
                            ////Print out Item Photo AND Hide APPENDIX3
                            rptViewer.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPurchaseOrderBatchPhotoMatrixByStockCodeRdl.rdlc";
                        }

                        else if (!chkPrintPhoto.Checked && chkHideAPPENDIX3.Checked)
                        {
                            ////Hide APPENDIX3
                            rptViewer.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPurchaseOrderBatchMatrixByStockCodeRdl.rdlc";
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    if (cboType.SelectedIndex == 0)
                    {
                        ...
                        {
                            ////Print out Item Photo 
                            rptViewer.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPOSummaryActivePhotoRdl.rdlc";
                        }
                        else
                        {
                            ////Hide Photo
                            rptViewer.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPOSummaryActiveRdl.rdlc";
                        }
                    ...
                    else
                    {
                        ...
                        {
                            ////Print out Item Photo 
                            rptViewer.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPOSummaryBatchPhotoRdl.rdlc";
                        }
                        else
                        {
                            ////Hide Photo
                            rptViewer.ReportName = "RT2008.Purchasing.Reports.OfficialDocument.Reports.OfficialPOSummaryBatchRdl.rdlc";
                        }
                    }
                }
                #endregion
