...
namespace RT2008.Purchasing.Wizard
{
    ...
    public partial class PurchaseOrder : Form, IGatewayComponent
    {
        ...
        private string GetStaffName(Guid staffId)
        {
            ...
            RT2008.DAL.Staff objStaff = RT2008.DAL.Staff.Load(staffId);
            if (objStaff != null)
            {
        ...
        {
            this.txtLastUpdate.Text = RT2008.SystemInfo.Settings.DateTimeToString(DateTime.Now, false);
        }
        #endregion
        ...
        private void ItemInfo(ref string stkCode, ref string appendix1, ref string appendix2, ref string appendix3)
        {
            ...
            {                
                RT2008.DAL.Product objProd = RT2008.DAL.Product.Load(new Guid(this.basicProduct.SelectedItem.ToString()));
                if (objProd != null)
                {
        ...
        {
            RT2008.DAL.Workplace.LoadCombo(ref this.cboLocation, new string[] { "WorkplaceCode", "WorkplaceInitial" }, "{0} - {1}", false, false, string.Empty, string.Empty, null);
        }
        ...
        {
            RT2008.DAL.ShipmentMethod.LoadCombo(ref this.cboShipmentMethod, "MethodCode", false);
        }
        ...
        {
            RT2008.DAL.SupplierTerms.LoadCombo(ref this.cboPaymentMethod, new string[] { "TermsCode", "TermsName" }, "{0} - {1}", false, false, string.Empty, string.Empty, null);
        }
        #endregion
        ...
        private void Save()
        {
            ...
            switch (this.cboType.SelectedItem.ToString().ToUpper())
            {
                case "FPO":
                default:
                    this.txtPurchaseOrderNo.Text = RT2008.SystemInfo.Settings.QueuingTxNumber(Common.Enums.POType.FPO);
                    type = Convert.ToInt32(Common.Enums.POType.FPO);
                    break;
                case "LPO":
                    this.txtPurchaseOrderNo.Text = RT2008.SystemInfo.Settings.QueuingTxNumber(Common.Enums.POType.LPO);
                    type = Convert.ToInt32(Common.Enums.POType.LPO);
                    break;
                case "OPO":
                    this.txtPurchaseOrderNo.Text = RT2008.SystemInfo.Settings.QueuingTxNumber(Common.Enums.POType.OPO);
        ...
        private void RdlToPdf()
        {
            ...
            rdlExport.ReportName = "RT2008.Purchasing.Wizard.Reports.POWorksheetRdl.rdlc";
