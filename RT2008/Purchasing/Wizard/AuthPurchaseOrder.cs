    ...
    public partial class AuthPurchaseOrder : Form
    {
        ...
        private void BindingHoldingList(SqlDataReader reader)
        {
            ...
            while (reader.Read())
            {
                ...
                objItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(3), false)); //// OrderDate
                objItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(7), false)); //// LastUpdate
