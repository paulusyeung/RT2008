...
namespace RT2008.Controls.ProductSearcher
{
    public partial class MatrixDetail : Form
    {
        ...
        {
            lblStockCode.Text = SystemInfo.Settings.GetSystemLabelByKey("STKCODE") + RT2008.Controls.Utility.Dictionary.GetColon();
            ...
            lblProductName.Text = RT2008.Controls.Utility.Dictionary.GetWordWithColon("description");
            lblTotalQty.Text = RT2008.Controls.Utility.Dictionary.GetWordWithColon("total_qty");
            lblTotalAmount.Text = RT2008.Controls.Utility.Dictionary.GetWordWithColon("total_amount");

            colQty.HeaderText = RT2008.Controls.Utility.Dictionary.GetWord("qty");
            colQtySubTotal.HeaderText = string.Format(RT2008.Controls.Utility.Dictionary.GetWord("subtotal_replace"), RT2008.Controls.Utility.Dictionary.GetWord("qty"));
            colUnitAmount.HeaderText = RT2008.Controls.Utility.Dictionary.GetWord("unit_amount");
            colAmountSubTotal.HeaderText = string.Format(RT2008.Controls.Utility.Dictionary.GetWord("subtotal_replace"), RT2008.Controls.Utility.Dictionary.GetWord("amount"));
            ...
            btnLoad.Text = RT2008.Controls.Utility.Dictionary.GetWord("load");
            btnOK.Text = RT2008.Controls.Utility.Dictionary.GetWord("ok");
            btnCancel.Text = RT2008.Controls.Utility.Dictionary.GetWord("cancel");
        }
