...
namespace RT2008.Controls.ProductSearcher
{
    public partial class Simple : Form
    {
        ...
        {
            this.lblStockCode.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("STKCODE");
            this.lblAppendix1.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1");
            this.lblAppendix2.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX2");
            this.lblAppendix3.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3");

            this.lblDescription.Text = RT2008.Controls.Utility.Dictionary.GetWord("description");
            this.btnFind.Text = RT2008.Controls.Utility.Dictionary.GetWord("Find");
            this.btnCancel.Text = RT2008.Controls.Utility.Dictionary.GetWord("Cancel");
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            //if (sql.Length > 0)
            //{
            //    RT2008.DAL.Product oProd = RT2008.DAL.Product.LoadWhere(sql.ToString());
            //    if (oProd != null)
            //    {
