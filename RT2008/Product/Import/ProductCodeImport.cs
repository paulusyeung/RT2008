...
namespace RT2008.Product.Import
{
    public partial class ProductCodeImport : Form
    {
        ...
        {
            Import.ProductCodeImportTemplate templateForm = new RT2008.Product.Import.ProductCodeImportTemplate();
        ...
        private string VerifyDuplicatedData(int iCount, DataRow row)
        {
            ...
            RT2008.DAL.Product oStockItem = RT2008.DAL.Product.LoadWhere(sql);
            if (oStockItem != null)
            {
        ...
        private Guid ImportProduct(StockCodeRec oRec)
        {
            ...
            RT2008.DAL.Product oItem = RT2008.DAL.Product.LoadWhere(productWhereClause.ToString());
            if (oItem == null)
            {
