    ...
    public partial class AnalysisCodeWizard : Form
    {
        ...
        private void Save()
        {
            if (Verify())
            {
                ...
                RT2008.Controls.Log4net.LogInfo(RT2008.Controls.Log4net.LogAction.Create, oAnalysisCode.ToString());

                this.AnalysisCodeId = oAnalysisCode.AnalysisCodeId;
                RT2008.SystemInfo.Settings.RefreshMainList<DefaultAnalysisCodeList>();
            }
        }
        ...
        private void Delete()
        {
            ...
            if (oAnalysisCode != null)
            {
                try
                {
                    ...
                    // log activity
                    RT2008.Controls.Log4net.LogInfo(RT2008.Controls.Log4net.LogAction.Delete, oAnalysisCode.ToString());
                }
                catch
                {
