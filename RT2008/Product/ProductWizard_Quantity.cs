...
namespace RT2008.Product
{
    public partial class ProductWizard_Quantity : UserControl
    {
        ...
        private DataTable BuildEmptyTable()
        {
            ...
            RT2008.DAL.WorkplaceCollection wList = RT2008.DAL.Workplace.LoadCollection(new string[] { "WorkplaceCode" }, true);
            foreach (RT2008.DAL.Workplace w in wList)
            {
        ...
        private void ShowCurrentSummaryInfo()
        {
            ...
            if (oCurrentSummary != null)
            {
                ...
                txtLastPurDate.Text = oCurrentSummary.LastPurchasedOn.ToString(RT2008.SystemInfo.Settings.GetDateFormat());
                txtLastSoldDate.Text = oCurrentSummary.LastSoldOn.ToString(RT2008.SystemInfo.Settings.GetDateFormat());
            }
        }
