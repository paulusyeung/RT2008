...
namespace RT2008.Product.Reports
{
    public partial class DimensionListRpt_Xls : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public DimensionListRpt_Xls()
        {
            ...
            this.hdrApp11.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1");
            this.hdrApp21.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX2");
            this.hdrApp31.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3");
        }
        ...
        private void DimensionListRptc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.txtPrint.Text = RT2008.SystemInfo.Settings.DateTimeToString(DateTime.Now, true);
        }
