...
namespace RT2008.Product.Reports
{
    ...
    public partial class RptDimensionList : Form
    {
        ...
        private void FillComboBox()
        {
            ...
            if (oDimList.Count > 0)
            {
                foreach (RT2008.DAL.ProductDim oProductDim in oDimList)
                {
        ...
        //    {
        //        RT2008.Product.Reports.DimensionListRpt_Pdf report = new DimensionListRpt_Pdf();
        ...
        //    {
        //        RT2008.Product.Reports.DimensionListRpt_Xls reportc = new DimensionListRpt_Xls();
        ...
        //    else
        //    {
        //        RT2008.Product.Reports.DimensionListRpt_Pdf rpt = new DimensionListRpt_Pdf();
        //        try
        //        {
        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            ...
            view.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_vwDimensionList";
            view.ReportName = "RT2008.Product.Reports.DimensionListRdl.rdlc";
