...
namespace RT2008.Product.Reports
{
    public partial class Appendix3CombinRpt_Xls : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Appendix3CombinRpt_Xls()
        {
            ...
            this.lblCaption.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3") + " Combin List";
            this.lblAppendix3.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3") + " Combin#";
        }
