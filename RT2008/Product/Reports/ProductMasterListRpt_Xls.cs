...
namespace RT2008.Product.Reports
{
    public partial class ProductMasterListRpt_Xls : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        {
            hdrStkCode1.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("STKCODE");
            hdrAppendix11.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1");
            hdrAppendix21.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX2");
            hdrAppendix31.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3");

            hdrClass11.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS1");
            hdrClass21.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS2");
            hdrClass31.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS3");
            hdrClass41.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS4");
            hdrClass51.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS5");
            hdrClass61.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS6");
        }
        #endregion
    }
}
