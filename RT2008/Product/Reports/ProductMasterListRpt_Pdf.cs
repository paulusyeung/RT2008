...
namespace RT2008.Product.Reports
{
    public partial class ProductMasterListRpt_Pdf : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        {
            lblSTK.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("STKCODE");
            lblA1.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1");
            lblA2.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX2");
            lblA3.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3");

            lblClass1.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS1");
            lblClass2.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS2");
            lblClass3.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS3");
            lblClass4.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS4");
            lblClass5.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS5");
            lblClass6.Text = "C1 : " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS6");
        }
        #endregion
    }
}
