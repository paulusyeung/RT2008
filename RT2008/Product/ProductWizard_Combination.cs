...
namespace RT2008.Product
{
    public partial class ProductWizard_Combination : Form
    {
        ...
        private void SetCtrlEditable()
        {
            ...
            this.Text = string.Format("Combination Wizard [{0}]", RT2008.SystemInfo.Settings.GetSystemLabelByKey(this.FormType.ToString().ToUpper()));
        }
        ...
        private void VisibleGridColumn(bool a1, bool a2, bool a3)
        {
            ...
            if (a1)
            {
                ...
                colA1.Name = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1");
            ...
            if (a2)
            {
                ...
                colA2.Name = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX2");
            ...
            if (a3)
            {
                ...
                colA3.Name = RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3");
        ...
        private void Save()
        {
            ...
            if (string.IsNullOrEmpty(errorProvider.GetError(txtCombinNumber)))
            {
                ...
                if (this.CombinId != System.Guid.Empty)
                {
                    RT2008.SystemInfo.Settings.RefreshMainList<DefaultCombinList>();
                }
            }
        }
