...
namespace RT2008.Product
{
    public partial class ProductWizard_Batch : Form
    {
        ...
        private void SetSystemLabels()
        {
            ...
            lnkAppendix1.Text = string.Format(combinNum, RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1"));
            lnkAppendix2.Text = string.Format(combinNum, RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX2"));
            lnkAppendix3.Text = string.Format(combinNum, RT2008.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3"));
        }
        #endregion
        ...
        private bool IsStockCodeExist()
        {
            ...
            RT2008.DAL.Product oProd = RT2008.DAL.Product.LoadWhere(sql);
            if (oProd != null)
            {
                result = true;
            }
            ...
            RT2008.DAL.ProductBatch oProdB = RT2008.DAL.ProductBatch.LoadWhere(sql);
            if (oProdB != null)
            {
                result = true;
            }
