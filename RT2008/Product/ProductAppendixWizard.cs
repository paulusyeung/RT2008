...
namespace RT2008.Product
{
    public partial class ProductAppendixWizard : Form
    {
        ...
        private void SetCaptions()
        {
            ...
            {
                this.Text += " [" + RT2008.SystemInfo.Settings.GetSystemLabelByKey("Appendix1") + "] ";
            }

            if (this.Appendix2 != null)
            {
                this.Text += " [" + RT2008.SystemInfo.Settings.GetSystemLabelByKey("Appendix2") + "] ";
            }

            if (this.Appendix3 != null)
            {
                this.Text += " [" + RT2008.SystemInfo.Settings.GetSystemLabelByKey("Appendix3") + "] ";
            }
        }
        ...
        private void Save()
        {
            ...
            else
            {
                ...
                {
                    RT2008.SystemInfo.Settings.RefreshMainList<DefaultAppendixList>();
                }
            }
        }
        ...
        private bool SaveAppendix1()
        {
            if (this.Appendix1 != null)
            {
                ...
                else
                {
                    ...
                    if (oA1.Count > 0)
                    {
                        errorProvider.SetError(txtCode, string.Format(Resources.Common.DuplicatedCode, RT2008.SystemInfo.Settings.GetSystemLabelByKey("Appendix1")));
                        return false;
                    }
                    else
                    {
        ...
        private bool SaveAppendix2()
        {
            if (this.Appendix2 != null)
            {
                ...
                else
                {
                    ...
                    if (oA2.Count > 0)
                    {
                        errorProvider.SetError(txtCode, string.Format(Resources.Common.DuplicatedCode, RT2008.SystemInfo.Settings.GetSystemLabelByKey("Appendix2")));
                        return false;
                    }
                    else
                    {
        ...
        private bool SaveAppendix3()
        {
            if (this.Appendix3 != null)
            {
                ...
                else
                {
                    ...
                    if (oA3.Count > 0)
                    {
                        errorProvider.SetError(txtCode, string.Format(Resources.Common.DuplicatedCode, RT2008.SystemInfo.Settings.GetSystemLabelByKey("Appendix3")));
                        return false;
                    }
                    else
                    {
        ...
        private void LoadAppendix1()
        {
            ...
            if (this.Appendix1 != null)
            {
                ...
                txtLastUpdatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(this.Appendix1.ModifiedOn, false);
                txtCreatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(this.Appendix1.CreatedOn, false);
        ...
        private void LoadAppendix2()
        {
            ...
            if (this.Appendix2 != null)
            {
                ...
                txtLastUpdatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(this.Appendix2.ModifiedOn, false);
                txtCreatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(this.Appendix2.CreatedOn, false);
        ...
        private void LoadAppendix3()
        {
            ...
            if (this.Appendix3 != null)
            {
                ...
                txtLastUpdatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(this.Appendix3.ModifiedOn, false);
                txtCreatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(this.Appendix3.CreatedOn, false);
