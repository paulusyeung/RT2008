...
namespace RT2008.Settings.MonthEndProcess
{
    public class ProcessSteps
    {
        ...
        public void Process()
        {
            ...
            string className = "RT2008.Settings.MonthEndProcess.Step";
        ...
        /// <param name="e">The <see cref="RT2008.SettingsMonthEndCommon.ProgressUpdateEventArgs"/> instance containing the event data.</param>
