    ...
    public class Step01 : IStep
    {
        ...
        private Guid CreateAdjSubLedgerHeader(Guid srcHeaderId, DateTime txDate, Guid workplaceId)
        {
            ...
            if (objHeader == null)
            {
                ...
                objHeader.TxNumber = SystemInfo.Settings.QueuingTxNumber(RT2008.DAL.Common.Enums.TxType.ADJ);
                objHeader.TxType = RT2008.DAL.Common.Enums.TxType.ADJ.ToString();
                ...
                objHeader.Status = (int)RT2008.DAL.Common.Enums.Status.Active;
        ...
        private void CreatedAdjSubLedgerDetails(Guid headerId, Guid productId, decimal cdQty)
        {
            ...
            objDetail.TxType = RT2008.DAL.Common.Enums.TxType.ADJ.ToString();
        ...
        private string GetShopCode(Guid workplaceId)
        {
            ...
            RT2008.DAL.Workplace shop = RT2008.DAL.Workplace.Load(workplaceId);
            if (shop != null)
            {
