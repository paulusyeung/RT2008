...
FROM        vwPaymentFactorList";
            ...
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(cmd))
            {
                while (reader.Read())
                {
                    ...
                    listItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(5), false)); // Start date
                    listItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(6), false)); // End date
                    listItem.SubItems.Add(reader.GetDecimal(7).ToString("n" + RT2008.SystemInfo.Settings.GetQtyDecimalPoint().ToString())); // Factor rate
                    listItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(8), true)); // Created On
                    listItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(10), true)); // Modified On
        ...
        private void FillWorkplaceList()
        {
            ...
            WorkplaceCollection workplaceList = RT2008.DAL.Workplace.LoadCollection(orderBy, true);
        ...
        private void LoadPaymentFactor()
        {
            ...
            if (oFactor != null)
            {
                ...
                txtCreatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(oFactor.CreatedOn, false);
                txtLastUpdatedBy.Text = GetStaffName(oFactor.ModifiedBy);
                txtLastUpdatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(oFactor.ModifiedOn, false);
            }
        }
