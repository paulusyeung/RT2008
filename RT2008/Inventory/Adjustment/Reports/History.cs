...
namespace RT2008.Inventory.Adjustment.Reports
{
    ...
    public partial class HistoryWizard : Form
    {
        ...
        public HistoryWizard()
        {
            ...
            RT2008.Controls.InvtUtility.ShowCriteria(ref txtTxNumberFrom, ref txtTxNumberTo, "vwRptSubLedgerADJ", Common.Enums.TxType.ADJ, dtpTxDateFrom.Value, dtpTxDateTo.Value);
        }
        ...
        //    RT2008.Inventory.Adjustment.Reports.HistoryRpt report = new RT2008.Inventory.Adjustment.Reports.HistoryRpt();
        ...
        private void cmdPreview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                oViewer.ReportName = "RT2008.Inventory.Adjustment.Reports.HistoryRdl.rdlc";
                oViewer.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_vwRptSubLedgerADJ";
        ...
        {
            RT2008.Controls.InvtTxSearcher findFromTxNumber = RT2008.Controls.InvtUtility.ShowTxSearcher("vwRptSubLedgerADJ", Common.Enums.TxType.ADJ);
        ...
        {
            RT2008.Controls.InvtTxSearcher findToTxNumber = RT2008.Controls.InvtUtility.ShowTxSearcher("vwRptSubLedgerADJ", Common.Enums.TxType.ADJ);
