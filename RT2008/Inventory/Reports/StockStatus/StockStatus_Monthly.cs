        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                if (ReportDataSourceName() == "vwRptStockStatus_Monthly")
                {
                    ...
                    {
                        view.ReportName = "RT2008.Inventory.Reports.StockStatus.StockStatus_MonthlyWithClassRdl.rdlc";
                    }
                    else if (this.cboStkRemark.Text.Trim() == "Description")
                    {
                        view.ReportName = "RT2008.Inventory.Reports.StockStatus.StockStatus_MonthlyWithDescRdl.rdlc";
                    }
                }
                else
                {
                    if (this.cboStkRemark.Text.Trim() == "Class 1 - 6")
                    {
                        view.ReportName = "RT2008.Inventory.Reports.StockStatus.StockStatus_MonthlyPeriodWithClassRdl.rdlc";
                    }
                    else if (this.cboStkRemark.Text.Trim() == "Description")
                    {
                        view.ReportName = "RT2008.Inventory.Reports.StockStatus.StockStatus_MonthlyPeriodWithDescRdl.rdlc";
                    }
                }
                #endregion
