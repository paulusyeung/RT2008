        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                if (ReportDataSourceName() == "vwRptStockStatus_StockValue")
                {
                    ...
                    {
                        view.ReportName = "RT2008.Inventory.Reports.StockStatus.StockStatus_RetailValueWithClassRdl.rdlc";
                    }
                    else if (this.cboStkRemark.Text.Trim() == "Description")
                    {
                        view.ReportName = "RT2008.Inventory.Reports.StockStatus.StockStatus_RetailValueWithDescRdl.rdlc";
                    }
                }
                else
                {
                    if (this.cboStkRemark.Text.Trim() == "Class 1 - 6")
                    {
                        view.ReportName = "RT2008.Inventory.Reports.StockStatus.StockStatus_RetailValuePeriodWithClassRdl.rdlc";
                    }
                    else if (this.cboStkRemark.Text.Trim() == "Description")
                    {
                        view.ReportName = "RT2008.Inventory.Reports.StockStatus.StockStatus_RetailValuePeriodWithDescRdl.rdlc";
                    }
                }
                #endregion
