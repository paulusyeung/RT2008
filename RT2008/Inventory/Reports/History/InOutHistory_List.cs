...
namespace RT2008.Inventory.Reports.History
{
    public partial class InOutHistory_List : Form
    {
        ...
        private DataTable StockCodeList()
        {
            ...
            DataSet ds = RT2008.DAL.SqlHelper.Default.ExecuteDataSet(cmd);
...
ORDER BY STKCODE, APPENDIX1, APPENDIX2, APPENDIX3, TxDate, TxType, TxNumber";
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                {"FromDate",this.dtpTxDateFrom.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
                {"ToDate",this.dtpTxDateTo.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
                ...
                view.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_vwInOutHistory";
                view.ReportName = "RT2008.Inventory.Reports.History.InOutHistory_ListRdl.rdlc";
