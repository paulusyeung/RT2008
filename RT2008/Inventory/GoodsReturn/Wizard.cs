...
namespace RT2008.Inventory.GoodsReturn
{
    public partial class Wizard : Form, IGatewayComponent, IWizard
    {
        ...
        void IGatewayComponent.ProcessRequest(IContext objContext, string strAction)
        {
            ...
            RT2008.Inventory.GoodsReturn.Reports.WorksheetRpt report = new RT2008.Inventory.GoodsReturn.Reports.WorksheetRpt();
...
";
        ...
        private void cmdPreview_Click()
        {
            ...
            oViewer.ReportName = "RT2008.Inventory.GoodsReturn.Reports.WorksheetRdl.rdlc";
        ...
        private void SaveREJ()
        {
            ...
            if (oHeader == null)
            {
                ...
                txtTxNumber.Text = RT2008.SystemInfo.Settings.QueuingTxNumber(Common.Enums.TxType.REJ);
            ...
            if (((Form)sender).DialogResult == DialogResult.Yes)
            {
                if (!this.Text.Contains("ReadOnly"))
                {
                    if (Save())
                    {
                        ...
                        this.Close();
                        RT2008.Inventory.GoodsReturn.Wizard wizard = new RT2008.Inventory.GoodsReturn.Wizard(this.REJId);
                        wizard.ShowDialog();
                    }
                }
                else
            ...
            if (((Form)sender).DialogResult == DialogResult.Yes)
            {
                if (!this.Text.Contains("ReadOnly"))
                {
                    if (Save())
                    {
                        RT2008.SystemInfo.Settings.RefreshMainList<Default>();
                        this.Close();
                        RT2008.Inventory.GoodsReturn.Wizard wizard = new RT2008.Inventory.GoodsReturn.Wizard();
                        wizard.ShowDialog();
                    }
                }
                else
