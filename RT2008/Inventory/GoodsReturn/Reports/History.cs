...
namespace RT2008.Inventory.GoodsReturn.Reports
{
    ...
    public partial class HistoryWizard : Form
    {
        ...
        public HistoryWizard()
        {
            ...
            RT2008.Controls.InvtUtility.ShowCriteria(ref txtTxNumberFrom, ref txtTxNumberTo, "vwRptSubLedgerCAP", Common.Enums.TxType.REJ, dtpTxDateFrom.Value, dtpTxDateTo.Value);
        }
        ...
        //    RT2008.Inventory.GoodsReturn.Reports.HistoryRpt report = new RT2008.Inventory.GoodsReturn.Reports.HistoryRpt();
        ...
        //    rdlExport.ReportName = "RT2008.Inventory.GoodsReturn.Reports.HistoryRdl.rdlc";
        //    rdlExport.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_vwRptSubLedgerCAP";
        ...
        private void cmdPreview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                oViewer.ReportName = "RT2008.Inventory.GoodsReturn.Reports.HistoryRdl.rdlc";
        ...
        {
            RT2008.Controls.InvtTxSearcher findFromTxNumber = RT2008.Controls.InvtUtility.ShowTxSearcher("vwRptSubLedgerCAP", Common.Enums.TxType.REJ);
        ...
        {
            RT2008.Controls.InvtTxSearcher findToTxNumber = RT2008.Controls.InvtUtility.ShowTxSearcher("vwRptSubLedgerCAP", Common.Enums.TxType.REJ);
