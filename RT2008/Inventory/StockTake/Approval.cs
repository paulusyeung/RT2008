    ...
    public partial class Approval : Form
    {
        ...
        private void BindingList()
        {
            ...
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(cmd))
            {
                while (reader.Read())
                {
                    ...
                    objItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(6), false) + " " + StaffNumber(reader.GetGuid(7))); // Last Update
                    objItem.SubItems.Add(string.Empty);
        ...
        private bool VerifyTxDate(string value)
        {
            ...
            if (!string.IsNullOrEmpty(value))
            {
                ...
                if (txDate[2].Equals(RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemYear) && txDate[1].Equals(RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemMonth))
                {
                    result = true;
                }
            }
