    ...
    public partial class Authorization : Form
    {
        ...
        private void BindingHoldingList()
        {
            ...
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(cmd))
            {
                while (reader.Read())
                {
                    ...
                    objItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(4), false)); // Modified On
        ...
        private void CreateLedgerDetails(string txnumber, Guid ledgerHeaderId, Guid stkHeaderId, string staff, string workplace)
        {
            ...
            foreach (StockTakeDetails stkDetail in stkDetailsList)
            {
                ...
                // Product Info
                RT2008.DAL.Product oItem = RT2008.DAL.Product.Load(stkDetail.ProductId);
                if (oItem != null)
                {
