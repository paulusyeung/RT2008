...
namespace RT2008.Inventory.Olap
{
    ...
    public partial class QohAtsNormalWithOlapConnection : System.Web.UI.Page
    {
        ...
        {
            RT2008.DAL.ProductCollection oProdList = RT2008.DAL.Product.LoadCollection(new string[] { "STKCODE" }, true);
        ...
        {
            return string.IsNullOrEmpty(RT2008.SystemInfo.Settings.GetSystemLabelByKey(key)) ? key : RT2008.SystemInfo.Settings.GetSystemLabelByKey(key);
        }
