        ...
        private void InitialPageValue()
        {
            if (System.Web.HttpContext.Current.Session["OCInventory"] != null)
            {
                ...
                if (objTable is Hashtable)
                {
                    ...
                    //string currentYear = RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemYear;
                    //string currentMonth = (int.Parse(RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemMonth) - 1).ToString("00");
