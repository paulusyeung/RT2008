...
namespace RT2008.Inventory.Olap
{
    public partial class CapSummary : System.Web.UI.Page
    {
        ...
        private void InitialPageValue()
        {
            if (System.Web.HttpContext.Current.Session["CapSummary"] != null)
            {
                ...
                if (objTable is Hashtable)
                {
                    ...
                    //this.txtFromData.Text = new DateTime(int.Parse(RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemYear),
                    //    int.Parse(RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemMonth), 1).ToString("dd/MM/yyyy");
        ...
        {
            return RT2008.SystemInfo.Settings.GetSystemLabelByKey(key);
        }
