        ...
        private void InitialPageValue()
        {
            if (System.Web.HttpContext.Current.Session["DiscrepancyAudit"] != null)
            {
                ...
                if (objTable is Hashtable)
                {
                    ...
                    //this.txtForMonth.Text = RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemYear +
                    //    int.Parse(RT2008.SystemInfo.CurrentInfo.Default.CurrentSystemMonth).ToString("00");
