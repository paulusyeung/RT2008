        ...
        private void BindingHoldingList()
        {
            ...
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(cmd))
            {
                while (reader.Read())
                {
                    ...
                    objItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(2), false)); // TxferDate
                    ...
                    objItem.SubItems.Add(RT2008.SystemInfo.Settings.DateTimeToString(reader.GetDateTime(13), false) + " " + StaffNumber(reader.GetGuid(14))); // Last Update
