...
namespace RT2008.Inventory.Replenishment
{
    public partial class Preparation : Form
    {
        ...
        private void FillFromList()
        {
            ...
            //wpList.Add(new RT2008.DAL.Workplace());
            ...
            RT2008.DAL.Workplace.LoadCombo(ref cboFromWorkplace, "WorkplaceCode", false, false, string.Empty, sql);
        }
        ...
        private void FillToList()
        {
            ...
            RT2008.DAL.Workplace.LoadCombo(ref cboToWorkplace, "WorkplaceCode", false, false, string.Empty, sql);
        ...
        private WorkplaceCollection GetWorkplaceList(string natureCode)
        {
            ...
            WorkplaceCollection wpList = RT2008.DAL.Workplace.LoadCollection(sql, orderBy, true);
        ...
        private string GetWorkplaceName(string whereClause)
        {
            ...
            RT2008.DAL.Workplace wp = RT2008.DAL.Workplace.LoadWhere(whereClause);
            if (wp != null)
            {
        ...
        private int SaveRec()
        {
            ...
            if (rbtnWH2WH.Checked)
            {
                ...
                string txNumber = RT2008.SystemInfo.Settings.QueuingTxNumber(Common.Enums.TxType.RPL);
