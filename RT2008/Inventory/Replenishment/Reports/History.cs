...
namespace RT2008.Inventory.Replenishment.Reports
{
    ...
    public partial class HistoryWizard : Form
    {
        ...
        //    RT2008.Inventory.Replenishment.Reports.HistoryRpt report = new RT2008.Inventory.Replenishment.Reports.HistoryRpt();
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                oViewer.ReportName = "RT2008.Inventory.Replenishment.Reports.HistoryRdl.rdlc";
                oViewer.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_vwRptSubLedgerRPL";
