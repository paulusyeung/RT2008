...
namespace RT2008.Inventory.GoodsReceive
{
    public partial class DefaultAts : UserControl
    {
        ...
        private void SetAtsInvt()
        {
            ...
            ddlNew.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Goods Receive"), string.Empty, "Goods_Receive"));
            ...
            ddlImport.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Goods Receive") + " (Text)", string.Empty, "Goods_Receive_Import_Txt"));
            ...
            if (!(e.MenuItem.Tag == null))
            {
                switch (e.MenuItem.Tag.ToString().ToLower())
                {
                    ...
                    case "goods_receive_export":
                        ...
                        break;
                    case "worksheet":
                        RT2008.Inventory.GoodsReceive.Reports.WorksheetWizard wizWorksheet = new RT2008.Inventory.GoodsReceive.Reports.WorksheetWizard();
                        wizWorksheet.ShowDialog();
                        break;
                    case "history":
                        RT2008.Inventory.GoodsReceive.Reports.HistoryWizard wizHistory = new RT2008.Inventory.GoodsReceive.Reports.HistoryWizard();
                        wizHistory.ShowDialog();
                        break;
                    case "journal":
                        RT2008.Inventory.GoodsReceive.Reports.JournalWizard wizJournal = new RT2008.Inventory.GoodsReceive.Reports.JournalWizard();
