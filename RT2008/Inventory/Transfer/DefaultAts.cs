...
namespace RT2008.Inventory.Transfer
{
    public partial class DefaultAts : UserControl
    {
        ...
        private void SetAtsInvt()
        {
            ...
            ddlNew.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Transfer"), string.Empty, "Transfer"));
            ddlNew.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Transfer - Picking Note"), string.Empty, "Transfer_Picking_Note"));
            ddlNew.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Transfer - Picking Note (Fast)"), string.Empty, "Transfer_Picking_Note_Fast"));
            ddlNew.MenuItems.Add(new MenuItem("-"));

            MenuItem auth = new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Transfer - Authorization"), string.Empty, "Transfer_Authorization");
            auth.Enabled = RT2008.Controls.UserUtility.IsAccessAllowed(Common.Enums.Permission.Posting);
            ddlNew.MenuItems.Add(auth);

            MenuItem confirm = new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Transfer - Confirmation"), string.Empty, "Transfer_Confirmation");
            ...
            switch (RT2008.Controls.UserUtility.SecurityLevel())
            {
                case "1":
                    ...
                    //ddlReports1.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Worksheet"), string.Empty, "Worksheet"));
                    ddlReports1.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("History"), string.Empty, "History"));
                    //ddlReports1.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Journal"), string.Empty, "Journal"));

                    ToolBarButton cmdReports1 = new ToolBarButton("Reports", RT2008.Controls.Utility.Dictionary.GetWord("Reports"));
                    cmdReports1.Style = ToolBarButtonStyle.DropDownButton;
                    cmdReports1.Image = new IconResourceHandle("16x16.16_reports.gif");
                    cmdReports1.Enabled = RT2008.Controls.UserUtility.IsAccessAllowed(Common.Enums.Permission.Write);
                ...
                default:
                    ...
                    ddlReports.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Worksheet"), string.Empty, "Worksheet"));
                    ddlReports.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("History"), string.Empty, "History"));
                    ddlReports.MenuItems.Add(new MenuItem(RT2008.Controls.Utility.Dictionary.GetWord("Journal"), string.Empty, "Journal"));

                    ToolBarButton cmdReports = new ToolBarButton("Reports", RT2008.Controls.Utility.Dictionary.GetWord("Reports"));
            ...
            if (!(e.MenuItem.Tag == null))
            {
                switch (e.MenuItem.Tag.ToString().ToLower())
                {
                    ...
                    case "transfer_authorization":
                        RT2008.Inventory.Transfer.Authorization wizAuth = new Authorization();
                        wizAuth.ShowDialog();
                        break;
                    ...
                    case "transfer_export":
                        ...
                        break;
                    case "worksheet":
                        RT2008.Inventory.Transfer.Reports.WorksheetWizard wizWorksheet = new RT2008.Inventory.Transfer.Reports.WorksheetWizard();
                        wizWorksheet.ShowDialog();
                        break;
                    case "history":
                        RT2008.Inventory.Transfer.Reports.HistoryWizard wizHistory = new RT2008.Inventory.Transfer.Reports.HistoryWizard();
                        wizHistory.ShowDialog();
                        break;
                    case "journal":
                        RT2008.Inventory.Transfer.Reports.JournalWizard wizJournal = new RT2008.Inventory.Transfer.Reports.JournalWizard();
