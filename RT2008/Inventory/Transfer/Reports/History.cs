...
namespace RT2008.Inventory.Transfer.Reports
{
    ...
    public partial class HistoryWizard:Form
    {
        ...
        //    RT2008.Inventory.Transfer.Reports.HistoryRpt report = new RT2008.Inventory.Transfer.Reports.HistoryRpt();
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                oViewer.ReportName = "RT2008.Inventory.Transfer.Reports.HistoryRdl.rdlc";
                oViewer.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_vwRptSubLedgerTXF";
        ...
        {
            RT2008.Controls.InvtTxSearcher findFromTxNumber = RT2008.Controls.InvtUtility.ShowTxSearcher("vwRptSubLedgerTXF", Common.Enums.TxType.TXF);
        ...
        {
            RT2008.Controls.InvtTxSearcher findToTxNumber = RT2008.Controls.InvtUtility.ShowTxSearcher("vwRptSubLedgerTXF", Common.Enums.TxType.TXF);
