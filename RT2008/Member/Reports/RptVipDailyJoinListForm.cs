...
ORDER BY DateOfRegister";
        ...
        private string ExportToExcel()
        {
            ...
            worksheet.Cell(2, 2).Value = dtpFromRegDate.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat()) + " TO " + dtpToRegDate.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat());
            worksheet.Cell(3, 1).Value = "PRINTED ON:";
            worksheet.Cell(3, 2).Value = DateTime.Now.ToString(RT2008.SystemInfo.Settings.GetDateFormat());
            // Header
        ...
        void IGatewayComponent.ProcessRequest(IContext objContext, string strAction)
        {
            ...
            if (fileName.Length > 0)
            {
                ...
                byte[] streamByte = RT2008.SystemInfo.Settings.ReadFully(stream, stream.Length);
                stream.Close();
