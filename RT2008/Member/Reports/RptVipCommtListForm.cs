...
WHERE VipNumber BETWEEN '" + from + @"' AND '" + to + @"'
 ...
 ORDER BY [Date Commence]";
        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            ...
            {"FromCommencementDate",this.dtpFromCommencementDate.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
            {"ToCommencementDate",this.dtpToCommencementDate.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
            ...
            view.ReportName = "RT2008.Member.Reports.VipCommencementListRdl.rdlc";
