...
WHERE VipNumber BETWEEN '" + from + @"' AND '" + to + @"'
 ...
 ORDER BY Birthday";
        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            ...
            {
                view.ReportName = "RT2008.Member.Reports.VipMLblBirthdayAtdForm_001ADCRdl.rdlc";
            }
            else
            {
                view.ReportName = "RT2008.Member.Reports.VipMLblBirthdayAtdForm_001CDARdl.rdlc";
            }
            #endregion
