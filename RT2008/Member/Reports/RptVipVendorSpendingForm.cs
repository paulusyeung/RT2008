...
namespace RT2008.Member.Reports
{
    public partial class RptVipVendorSpendingForm : Form
    {
        ...
        {
            chkClass1.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS1");
...
";
        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            ...
            {
                string[,] param = {
                {"FromTxDate",this.dtpTrnFromTime.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
                {"ToTxDate",this.dtpTrnToTime.Value.ToString(RT2008.SystemInfo.Settings.GetDateFormat())},
                ...
                view.ReportName = "RT2008.Member.Reports.VipVendorSpendingFormRdl.rdlc";
                ...
                {
                    MessageBox.Show(String.Format("Must select at least one {0}!", RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS1")), "Please Select");
                    view.Close();
                }
            }
        }
