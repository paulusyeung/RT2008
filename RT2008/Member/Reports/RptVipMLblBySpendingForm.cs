...
namespace RT2008.Member.Reports
{
    public partial class RptVipMLblBySpendingForm : Form
    {
        ...
        {
            this.chkClass1.Text = RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS1");
            this.Text = "Top Vip Spending by " + RT2008.SystemInfo.Settings.GetSystemLabelByKey("CLASS1");
        }
        ...
        {
            SalutationCollection SalList = RT2008.DAL.Salutation.LoadCollection(new string[] { "SalutationName" }, true);
            foreach (RT2008.DAL.Salutation Sal in SalList)
            {
        ...
        private void FillShopList()
        {
            ...
            WorkplaceCollection wpList = RT2008.DAL.Workplace.LoadCollection(sql, new string[] { "WorkplaceCode" }, true);
        ...
        {
            ProductClass1Collection Class1List = RT2008.DAL.ProductClass1.LoadCollection(new string[] { "Class1Code" }, true);
            foreach (RT2008.DAL.ProductClass1 Class1 in Class1List)
            {
...
AND LEN(Address1)>0 AND LEN(Address2)>0 AND LEN(Address3)>0";
        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                view.ReportDatasourceName = "RT2008_Controls_Reporting_DataSource_vwVIP_TopSpending";
                ...
                if (rbtnLayout_1.Checked)
                {
                    ...
                    if (rbtnVIP_L001.Checked)
                    {
                        view.ReportName = "RT2008.Member.Reports.VipMLblBySpendingForm_L001ADCRdl.rdlc";
                    }
                    else if (rbtnVIP_L002.Checked)
                    {
                        view.ReportName = "RT2008.Member.Reports.VipMLblBySpendingForm_L002ADCRdl.rdlc";
                    }
                    else if (rbtnVIP_L003.Checked)
                    {
                        view.ReportName = "RT2008.Member.Reports.VipMLblBySpendingForm_L003ADCRdl.rdlc";
                    }
                    else if (rbtnVIP_L004.Checked)
                    {
                        view.ReportName = "RT2008.Member.Reports.VipMLblBySpendingForm_L004ADCRdl.rdlc";
                    }
                }
                else if(rbtnLayout_2.Checked)
                {
                    ...
                    if (rbtnVIP_L001.Checked)
                    {
                        view.ReportName = "RT2008.Member.Reports.VipMLblBySpendingForm_L001CDARdl.rdlc";
                    }
                    else if (rbtnVIP_L002.Checked)
                    {
                        view.ReportName = "RT2008.Member.Reports.VipMLblBySpendingForm_L002CDARdl.rdlc";
                    }
                    else if (rbtnVIP_L003.Checked)
                    {
                        view.ReportName = "RT2008.Member.Reports.VipMLblBySpendingForm_L003CDARdl.rdlc";
                    }
                    else if (rbtnVIP_L004.Checked)
                    {
                        view.ReportName = "RT2008.Member.Reports.VipMLblBySpendingForm_L004CDARdl.rdlc";
                    }
                }
                #endregion
