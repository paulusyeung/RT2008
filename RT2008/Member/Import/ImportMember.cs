...
namespace RT2008.Member.Import
{
    public partial class ImportMember : Form
    {
        ...
        private Guid GetPhoneTagId(string priority)
        {
            System.Guid result = System.Guid.Empty;
            string sql = "Priority = '" + priority + "'";
            RT2008.DAL.PhoneTag oTag = RT2008.DAL.PhoneTag.LoadWhere(sql);
            if (oTag != null)
            {
        ...
        private void SaveSmartTag(Guid memberId, MemberTemplate member)
        {
            ...
            oDateOfBirthTag.SmartTagValue = RT2008.SystemInfo.Settings.DateTimeToString(member.DATE_BIRTH, false);
            ...
            oDateOfRegisterTag.SmartTagValue = RT2008.SystemInfo.Settings.DateTimeToString(member.DATE_REGIS, false);
