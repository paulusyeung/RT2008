    ...
    public partial class MemberWizard : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (_EveryMemberIsVip)
            {
                ...
                this.VipNumber = RT2008.Controls.Member.GetNextVipNumber(_Use13DigitsVipNumber);
            }
            this.CheckVipInfo();
        ...
        {
            txtMemberNumber.BackColor = (this.MemberId == System.Guid.Empty) ? RT2008.SystemInfo.ControlBackColor.RequiredBox : RT2008.SystemInfo.ControlBackColor.DisabledBox;
            txtMemberNumber.ReadOnly = (this.MemberId != System.Guid.Empty);

            cboLineOfOperation.BackColor = RT2008.SystemInfo.ControlBackColor.RequiredBox;
        }
        #endregion
        ...
        private bool Verify()
        {
            ...
            else
            {
                ...
                if (this.MemberId == System.Guid.Empty)
                {
                    ...
                    RT2008.DAL.Member oMember = RT2008.DAL.Member.LoadWhere(sql);
        ...
        private bool Save()
        {
            if (Verify() && VerifyNumbers())
            {
                ...
                RT2008.DAL.Member oMember = RT2008.DAL.Member.Load(this.MemberId);
                if (oMember == null)
                {
                    oMember = new RT2008.DAL.Member();
                ...
                {// log activity (New Record)
                    RT2008.Controls.Log4net.LogInfo(RT2008.Controls.Log4net.LogAction.Create, oMember.ToString());
                }
                else
                { // log activity (Update)
                    RT2008.Controls.Log4net.LogInfo(RT2008.Controls.Log4net.LogAction.Update, oMember.ToString());
                }     
        ...
        private void LoadMemberInfo()
        {
            ...
            if (oMember != null)
            {
                ...
                main.txtLastUpdatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(oMember.ModifiedOn, false);
                main.txtCreatedOn.Text = RT2008.SystemInfo.Settings.DateTimeToString(oMember.CreatedOn, false);
