...
namespace RT2008.AtsPane
{
    public partial class PurchasingAts : UserControl
    {
        ...
        private void SetAtsPurchase()
        {
            ...
            poAuth.Enabled = RT2008.Controls.UserUtility.IsAccessAllowed(Common.Enums.Permission.Posting);
            ...
            recAuth.Enabled = RT2008.Controls.UserUtility.IsAccessAllowed(Common.Enums.Permission.Posting);
            ...
            if (!(e.MenuItem.Tag == null))
            {
                switch (e.MenuItem.Tag.ToString().ToLower())
                {
                    case "purpurchaseorders_multipleloc":
                        RT2008.Purchasing.Wizard.ByMultipleLocation wizMultipleLoc = new RT2008.Purchasing.Wizard.ByMultipleLocation();
                        wizMultipleLoc.ShowDialog();
                        break;
                    case "purpurchaseorders":
                        RT2008.Purchasing.Wizard.PurchaseOrder wizPO = new RT2008.Purchasing.Wizard.PurchaseOrder();
                        wizPO.ShowDialog();
                        break;
                    case "purpurchaseorders_auth":
                        RT2008.Purchasing.Wizard.AuthPurchaseOrder wizAuthPO = new RT2008.Purchasing.Wizard.AuthPurchaseOrder();
                        wizAuthPO.ShowDialog();
                        break;
                    case "purgoodsreceive":
                        RT2008.Purchasing.Wizard.ReceivingFind wizReceivingFind = new RT2008.Purchasing.Wizard.ReceivingFind();
                        wizReceivingFind.ShowDialog();
                        break;
                    case "purgoodsreceive_auth":
                        RT2008.Purchasing.Wizard.AuthPOReceiving wizAuthReceiving = new RT2008.Purchasing.Wizard.AuthPOReceiving();
                        wizAuthReceiving.ShowDialog();
                        break;
                    case "purreceivingppc":
                        RT2008.Purchasing.Import.FromPPC wizFromPPC = new RT2008.Purchasing.Import.FromPPC();
                        wizFromPPC.ShowDialog();
                        break;
                    case "purworksheet":
                        RT2008.Purchasing.Reports.PurchaseOrder.Worksheet wizWorksheet = new RT2008.Purchasing.Reports.PurchaseOrder.Worksheet();
                        wizWorksheet.ShowDialog();
                        break;
                    case "purhistory":
                        RT2008.Purchasing.Reports.PurchaseOrder.History wizHistory = new RT2008.Purchasing.Reports.PurchaseOrder.History();
                        wizHistory.ShowDialog();
                        break;
                    case "purvoidedworksheet":
                        RT2008.Purchasing.Reports.PurchaseOrder.VoidedWorksheet wizVoidedWorksheet = new RT2008.Purchasing.Reports.PurchaseOrder.VoidedWorksheet();
                        wizVoidedWorksheet.ShowDialog();
                        break;
                    case "purorderstatus":
                        RT2008.Purchasing.Reports.PurchaseOrder.OrderStatus wizOrderStatus = new RT2008.Purchasing.Reports.PurchaseOrder.OrderStatus();
                        wizOrderStatus.ShowDialog();
                        break;
                    case "purrecvworksheet":
                        RT2008.Purchasing.Reports.Receiving.Worksheet wizRecvWorksheet = new RT2008.Purchasing.Reports.Receiving.Worksheet();
                        wizRecvWorksheet.ShowDialog();
                        break;
                    case "purrecvhistory":
                        RT2008.Purchasing.Reports.Receiving.History wizRecvHistory = new RT2008.Purchasing.Reports.Receiving.History();
                        wizRecvHistory.ShowDialog();
                        break;
                    case "purrecvdiscrepency":
                        RT2008.Purchasing.Reports.Receiving.Discrepancy wizRecvDiscrepancy = new RT2008.Purchasing.Reports.Receiving.Discrepancy();
                        wizRecvDiscrepancy.ShowDialog();
                        break;
                    case "purexpectedrecvsummay_weekly":
                        RT2008.Purchasing.Reports.Receiving.WeeklyExpectedSummary wizRecvSummary = new RT2008.Purchasing.Reports.Receiving.WeeklyExpectedSummary();
