...
namespace RT2008.Client.Purchasing.Wizard
{
    ...
    {
        private List<Inventory.GoodsReceive.DetailData> _Result = new List<RT2008.Client.Inventory.GoodsReceive.DetailData>();
        ...
        public ByMultipleLocation()
        {
            ...
            this.BindingList(RT2008.DAL.Common.Enums.Status.Draft); //// Holding
        }
        ...
        private void FillSupplierList()
        {
            ...
            RT2008.DAL.SupplierCollection supplierList = RT2008.DAL.Supplier.LoadCollection(new String[] { "SupplierCode" }, true);
        ...
        private void FillOperationList()
        {
            ...
            RT2008.DAL.StaffCollection staffList = RT2008.DAL.Staff.LoadCollection(new String[] { "StaffNumber" }, true);
        ...
        private void FillCurrencyList()
        {
            ...
            RT2008.DAL.CurrencyCollection currencyList = Currency.LoadCollection();
        ...
        private void cmdSave_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Save Record?", "Save Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                if (!this.Text.Contains("ReadOnly"))
                {
                    ...
                    {
                        //RT2008.SystemInfo.Settings.RefreshMainList<DefaultPOList>();
        ...
        private void LoadCAPDetailsInfo(Guid detailId)
        {
            ...
            cmd.CommandTimeout = RT2008.DAL.Common.Config.CommandTimeout;
        ...
        {
            DataTable table;
            table = this.DataSource(RT2008.DAL.Common.Enums.Status.Draft.ToString("d"), false);
        ...
        private void Save()
        {
            ...
            foreach (DataGridViewRow rows in dgvLocationsList.Rows)
            {
                if (rows.Cells[0].Value != null && rows.Cells[0].Value.ToString() == "*")
                {
                    ...
                    objHeader.CreatedBy = RT2008.DAL.Common.Config.CurrentUserId;
                    ...
                    {
                        case "FPO":
                            orderNumber = Common.Utility.QueuingTxNumber(RT2008.DAL.Common.Enums.POType.FPO);
                            type = Convert.ToInt32(RT2008.DAL.Common.Enums.POType.FPO);
                            break;
                        case "LPO":
                            orderNumber = Common.Utility.QueuingTxNumber(RT2008.DAL.Common.Enums.POType.LPO);
                            type = Convert.ToInt32(RT2008.DAL.Common.Enums.POType.LPO);
                            break;
                        case "OPO":
                            orderNumber = Common.Utility.QueuingTxNumber(RT2008.DAL.Common.Enums.POType.OPO);
                            type = Convert.ToInt32(RT2008.DAL.Common.Enums.POType.OPO);
                            break;
                    }
                    ...
                    objHeader.Status = Purchasing.PurchasingUtils.Convert.ToInt32(this.cboStatus.Text == "HOLD" ? RT2008.DAL.Common.Enums.Status.Draft.ToString("d") : RT2008.DAL.Common.Enums.Status.Active.ToString("d"));
                    ...
                    //objHeader.TotalCost = RT2008.Purchasing.PurchasingUtils.Convert.ToDecimal(this.txtTotalAmount.Text);
                    //objHeader.TotalQty = RT2008.Purchasing.PurchasingUtils.Convert.ToDecimal(this.txtTotalQty.Text);

                    objHeader.ModifiedBy = RT2008.DAL.Common.Config.CurrentUserId;
        ...
        private decimal InitCurrency(string currencyCode)
        {
            ...
            {
                value = this.InitCurrency(RT2008.DAL.Common.Utility.IsGUID(this.cboCurrency.SelectedValue.ToString()) ? System.Guid.Empty : new System.Guid(this.cboCurrency.SelectedValue.ToString()));
            }
        ...
        private void ItemInfo(ref string stkCode, ref string appendix1, ref string appendix2, ref string appendix3)
        {
                ...
                RT2008.DAL.Product objProd = RT2008.DAL.Product.Load(new Guid(dgvDetailsList.Rows[dgvDetailsList.CurrentCell.RowIndex].Cells[8].Value.ToString()));
                if (objProd != null)
                {
        ...
        private void dgvDetailsList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                if (RT2008.DAL.Common.Utility.IsGUID(this.dgvDetailsList.Rows[dgvDetailsList.CurrentCell.RowIndex].Cells[0].Value.ToString()))
                {
        ...
        {
            Inventory.GoodsReceive.Detail detail = new RT2008.Client.Inventory.GoodsReceive.Detail();
        ...
        {
            List<Inventory.GoodsReceive.DetailData> resultList = new List<RT2008.Client.Inventory.GoodsReceive.DetailData>();
            ...
            foreach(DataGridViewRow rows in dgvDetailsList.Rows)
            {
                if (rows.Cells[3].Value.ToString().Trim() == STKCODE)
                {
                    ...
                    if (DAL.Common.Utility.IsGUID(rows.Cells[8].Value.ToString()))
                    {
                        ...
                        if (detailDate == null)
                        {
                            detailDate = new RT2008.Client.Inventory.GoodsReceive.DetailData();
