...
namespace RT2008.Client.Purchasing.Wizard
{
    public partial class Receiving : Form
    {
        ...
        private void FillLocationList()
        {
            ...
            RT2008.DAL.WorkplaceCollection workplaceList = DAL.Workplace.LoadCollection(new String[] { "WorkplaceCode" }, true);
...
WHERE ReceiveHeaderId = '" + this.ReceivingHeaderId.ToString() + "'";
        ...
        {
            RT2008.DAL.Product objProd = RT2008.DAL.Product.Load(new Guid(this.dgvDetailsList.Rows[dgvDetailsList.CurrentCell.RowIndex].Cells[dgvDetailsList.Columns["colProductId"].Index].Value.ToString()));
            if (objProd != null)
            {
