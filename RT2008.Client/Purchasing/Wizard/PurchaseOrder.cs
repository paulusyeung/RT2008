...
namespace RT2008.Client.Purchasing.Wizard
{
    public partial class PurchaseOrder : Form
    {
        ...
        private void FillShipmentMethodList()
        {
            ...
            RT2008.DAL.ShipmentMethodCollection shipmentMethodList = RT2008.DAL.ShipmentMethod.LoadCollection(new String[] { "MethodCode" }, true);
        ...
        private void FillSupplierTermsList()
        {
            ...
            RT2008.DAL.SupplierTermsCollection supplierTermsList = DAL.SupplierTerms.LoadCollection(new String[] { "TermsCode" }, true);
...
WHERE	OrderHeaderId = '" + this.OrderHeaderId.ToString() + "'";
        ...
        {
            RT2008.DAL.Product objProd = RT2008.DAL.Product.Load(new Guid(this.dgvDetailsList.Rows[dgvDetailsList.CurrentCell.RowIndex].Cells[13].Value.ToString()));
            if (objProd != null)
            {
