...
namespace RT2008.Client.Inventory.GoodsReceive
{
    public partial class Wizard : WizardBase
    {
        ...
        private void FillCurrencyList()
        {
            ...
            RT2008.DAL.CurrencyCollection CurrencyList = RT2008.DAL.Currency.LoadCollection(new String[] { "CurrencyCode" }, true);
