...
namespace RT2008.Client.Inventory.GoodsReceive
{
    public partial class Default : Form
    {
        ...
        private void BindList()
        {
            ...
            {
                sql += " WHERE " + whereClause + " AND TxType = '" + RT2008.DAL.Common.Enums.TxType.CAP.ToString() + "'";
            }
            else
            {
                sql += " WHERE TxType = '" + RT2008.DAL.Common.Enums.TxType.CAP.ToString() + "'";
            }
        ...
        private void FillcboCreateBy()
        {
            ...
            RT2008.DAL.StaffCollection staffCol = RT2008.DAL.Staff.LoadCollection(orderBy, true);
            staffCol.Add(new RT2008.DAL.Staff());
