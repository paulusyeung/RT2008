...
namespace RT2008.Client
{
    public partial class SqlConnection : Form
    {
        ...
        private void Save()
        {
            ...
            if (radWinAuth.Checked)
            {
                // Data Source=localhost;Initial Catalog=RT2008.Client;Integrated Security=True
                sql = String.Format("Data Source={0};Initial Catalog=RT2008;Integrated Security=True", txtServerName.Text.Trim());
            }
            else
            {
                // Data Source=localhost;Initial Catalog=RT2008.Client;Persist Security Info=True;User ID=sa;Password=sa9602
                sql = String.Format("Data Source={0};Initial Catalog=RT2008;Persist Security Info=True;User ID=sa;Password=Isaboutique123", txtServerName.Text.Trim());
            }
