                ...
                || txtCode.Text.Trim().Length > 0 || txtLoyalty.Text.Trim().Length > 0)
            {
                ...
                if (table.Rows.Count > 0)
                {
                    ...
                    switch (txtLayout.Text.Trim())
                    {
                        case "1":
                        case "2":
                            this.rptViewer.ReportName = "RT2008.Web.Reports.Rdlc.VIPSalesAnalysisFullList.rdlc";
                            break;
                        case "3":
                            this.rptViewer.ReportName = "RT2008.Web.Reports.Rdlc.VIPSalesAnalysisByClass2.rdlc";
                            break;
                        case "4":
                            this.rptViewer.ReportName = "RT2008.Web.Reports.Rdlc.VIPSalesAnalysisNoOfVisits.rdlc";
                            break;
                        case "5":
                            this.rptViewer.ReportName = "RT2008.Web.Reports.Rdlc.VIPSalesAnalysisByClass5.rdlc";
                            break;
                        case "6":
                            this.rptViewer.ReportName = "RT2008.Web.Reports.Rdlc.VIPSalesAnalysisFullListByClass.rdlc";
                            break;
                        default:
                            this.rptViewer.ReportName = "RT2008.Web.Reports.Rdlc.VIPSalesAnalysisFullList.rdlc";
                            break;
