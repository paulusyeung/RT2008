...
namespace RT2008.Web.Reports.Forms
{
    public partial class VipApplyForm : Form
    {
        ...
        private void GetDraftVIPNumber()
        {
            ...
            RT2008.DAL.MemberCollection oMemberList = RT2008.DAL.Member.LoadCollection(query, new string[] { "MemberNumber" }, true);
            foreach (RT2008.DAL.Member oMember in oMemberList)
            {
