        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
                    ...
                    txtYear.Text.Trim().Length>0))
            {
                ...
                if (table.Rows.Count > 0)
                {
                    ...
                    //this.rptViewer.ReportName = "RT2008.Web.Reports.Rdlc.DailyShopTransactionRdl.rdlc";
                    this.rptViewer.ReportName = "RT2008.Web.Reports.Rdlc.DailyShopTransactionMaster.rdlc";
