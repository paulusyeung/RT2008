...
namespace RT2008.Web.Shop.Public
{
    public partial class Logon : LogonForm
    {
        ...
        private bool AuthLogon()
        {
            ...
            if (oStaff != null)
            {
                if (oStaff.Status > Convert.ToInt32(RT2008.DAL.Common.Enums.Status.Inactive.ToString("d")))
                {
                    if (!oStaff.Retired)
                    {
        ...
        private bool AuthShopLogon()
        {
            ...
            if (RT2008.DAL.Common.Utility.IsGUID(wpId))
            {
                ...
                if (oWp != null)
                {
                    ...
                    {
                        if (oWp.Status > Convert.ToInt32(RT2008.DAL.Common.Enums.Status.Inactive.ToString("d")))
                        {
                            if (!oWp.Retired)
                            {
