...
namespace RT2008.Web.Shop.Common
{
    public class Utility
    {
        ...
        /// <returns></returns>
        public static string QueuingTxNumber(RT2008.DAL.Common.Enums.TxType txType)
        {
        ...
        public static string QueuingTxNumber<T>(T typeName)
        {
            ...
            {
                case "TxType":
                    RT2008.DAL.Common.Enums.TxType txType = (RT2008.DAL.Common.Enums.TxType)Convert.ChangeType(typeName, typeof(RT2008.DAL.Common.Enums.TxType));
                    queuingNumber += txType.ToString("d").PadLeft(2, '0');
                    lblLastNumber += txType.ToString();
                    break;
                case "POType":
                    RT2008.DAL.Common.Enums.POType poType = (RT2008.DAL.Common.Enums.POType)Convert.ChangeType(typeName, typeof(RT2008.DAL.Common.Enums.POType));
        ...
        public static Guid CurrentUserId
        {
            get
            {
                ...
                {
                    if (RT2008.DAL.Common.Utility.IsGUID(HttpContext.Current.Request.Cookies["RT2K8_WebShop_LogonStaff"].Value))
                    {
        ...
        public static Guid CurrentWorkplaceId
        {
            get
            {
                ...
                {
                    if (RT2008.DAL.Common.Utility.IsGUID(HttpContext.Current.Request.Cookies["RT2K8_WebShop_WorkplaceId"].Value))
                    {
