...
namespace RT2008.Web.Shop.StockReplenishment
{
...
ORDER BY p.STKCODE, p.APPENDIX1, p.APPENDIX2, p.APPENDIX3";
        ...
        private void SaveHeaderInfo()
        {
            ...
            if (oRPL == null)
            {
                ...
                txNumber = Common.Utility.QueuingTxNumber(RT2008.DAL.Common.Enums.TxType.RPL);
        ...
        private void SaveDetailInfo()
        {
            for (int i = 0; i < listView.Items.Count; i++)
            {
                ...
                {
                    if (RT2008.DAL.Common.Utility.IsGUID(oItem.SubItems[0].Text))
                    {
        ...
        private void listView_Click(object sender, EventArgs e)
        {
            ...
            {
                if (RT2008.DAL.Common.Utility.IsGUID(listView.SelectedItem.Text))
                {
