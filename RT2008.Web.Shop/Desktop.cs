...
namespace RT2008.Web.Shop
{
    public partial class Desktop : Form
    {
        ...
        {
            StockReplenishment.Default frmReplenishment = new RT2008.Web.Shop.StockReplenishment.Default();
        ...
        {
            Transfer.Default frmTransfer = new RT2008.Web.Shop.Transfer.Default();
